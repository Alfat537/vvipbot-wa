...
const BotName = 'ALFAT BOT'; 
const instagram = 'abdullahfatih537'; 
const aktif = 'Kapan Aja (Tergantung Internet :v)';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Fatih\n' // Nama kamu
            + 'ORG:ALFAT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6288287243319:+62 882-8724-3319\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
